...
class F72021(CecBenchmark):
    ...
    def evaluate(self, x, *args):
        ...
        mz = np.dot(self.f_matrix, z1)
        return (operator.expanded_schaffer_f6_func(mz[:self.n1])
...
class F92021(CecBenchmark):
    ...
    def __init__(self, ndim=None, bounds=None, f_shift="shift_data_9", f_matrix="M_9_D", f_bias=2400.):
        super().__init__()
        self.dim_changeable = True
        self.dim_default = 10
        self.dim_max = 20
...
class F102021(CecBenchmark):
    ...
    def __init__(self, ndim=None, bounds=None, f_shift="shift_data_10", f_matrix="M_10_D", f_bias=2500.):
        super().__init__()
        self.dim_changeable = True
        self.dim_default = 10
        self.dim_max = 20
